     ...
     <main class="principal">
          ...
          <div class="container register">
               ...
               <div class="container column">
                    <div class="container row">
                         <h2 class="map__title">Editar Plano</h2>
                    </div>
               </div>
               <form action="PLANOSupdate.php" method="POST" class="form">
                    <fieldset class="container" style="display: block;">
                                   ...
                                   <div class="container row">
                                        <div class="conteudo">
                                             <div class="icone-input">
                                                  ...
                                                  <input type="number" name="quantidadeCamaCasal" id="quantidadeCamaCasal" class="campo-input" placeholder="Qtd Casal" value="<?php echo $quantidadeCamaCasal ?>" required>
                                             </div>
                                             ...
                                             <div class="icone-input">
                                                  ...
                                                  <input type="number" name="quantidadeCamaSolteiro" id="quantidadeCamaSolteiro" class="campo-input"  placeholder="Qtd Solteiro" value="<?php echo $quantidadeCamaSolteiro ?>" required>
                                             </div>
                                        </div>
                                   </div>
                         ...
                         <div class="container row">
                              <div class="container__dados">
                                   ...
                                   <input type="text" name="valor" id="valor" class="inputs__data" value="<?php echo $valor ?>" required>
                              </div>
                         </div>
                         <br>
                         ...
                         <div class="container row">
                              ...
                              <input type="checkbox" id="cafe" name="cafe" <?php if ($cafe == 1) echo 'checked'; ?>>
                              <label for="cafe">Café da Manhã</label>

                              <input type="checkbox" id="openBar" name="openBar" <?php if ($openBar == 1) echo 'checked'; ?>>
                              <label for="openBar">Open Bar</label>

                              <input type="checkbox" id="openFood" name="openFood" <?php if ($openFood == 1) echo 'checked'; ?>>
                              <label for="openFood">Open Food</label>

                              <input type="checkbox" id="frigoBar" name="frigoBar" <?php if ($frigoBar == 1) echo 'checked'; ?>>
                              <label for="frigoBar">Frigobar</label>

                              <input type="checkbox" id="tvAhCabo" name="tvAhCabo" <?php if ($tvAhCabo == 1) echo 'checked'; ?>>
